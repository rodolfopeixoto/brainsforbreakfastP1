...
gulp.task('clean', function() {
    return gulp.src(['!dist/assets/img/rodolfo.png','dist/assets','dist/*.html','dist/*.php'], {read: false})
        .pipe($.clean());
});
...
gulp.task('rev', function(){
  return gulp.src(['!dist/assets/img/rodolfo.png','dist/**/*.{css,js,jpg,jpeg,png,svg}'])
    .pipe($.rev())
    .pipe($.revdel())
    .pipe(gulp.dest('dist/'))
    .pipe($.rev.manifest())
...
gulp.task('revreplace', ['rev'], function(){
  return gulp.src(['!dist/assets/img/rodolfo.png','dist/*.html', 'dist/app.yaml', 'dist/**/*.css'])
    .pipe($.revReplace({
